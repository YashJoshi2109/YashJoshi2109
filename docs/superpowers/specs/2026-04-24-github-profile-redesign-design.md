...
* Image: banner\_github.jpg at 100% width
* Animated typing SVG via readme-typing-svg.demolab.com

  * Cycles: "Data Scientist" → "ML Engineer & AI Engineer" → "Open Source Builder" → "MS @ UT Arlington"
...
* Ask me about: ML pipeline design, LLM's, FastAPI + Docker deployment, hackathon architecture
* Fun fact: built a full CI/CD analytics dashboard (Jenkins + Docker + K8s + GitHub Actions) in a single hackathon weekend — and trained & published multi-modal AI models on HuggingFace 🤗 spanning NLP, computer vision, and generative AI
...
| Platform    | Link                                                                                   |
| ----------- | -------------------------------------------------------------------------------------- |
| Discord     | ​[https://discord.gg/yashjoshi2124](https://discord.gg/yashjoshi2124)​                 |
| LinkedIn    | ​[https://www.linkedin.com/in/yash-joshi21](https://www.linkedin.com/in/yash-joshi21)​ |
| X (Twitter) | ​[https://x.com/yashjosh7486](https://x.com/yashjosh7486)​                             |
| YouTube     | ​[https://youtube.com/@Yash\_Joshi](https://youtube.com/@Yash_Joshi)​                  |
| HuggingFace | ​[https://huggingface.co/yashj2110](https://huggingface.co/yashj2110)​                 |
| Email       | ​[yashjosh7486@gmail.com](mailto:yashjosh7486@gmail.com)​                              |
...
All cards: bg\_color=0d1117, title\_color=00D4FF, text\_color=ffffff, border\_color=00D4FF

### 6. Activity Graph

* Service: github-readme-activity-graph.vercel.app
* Full width
* Theme: react-dark or custom with bg\_color=0d1117\&color=00D4FF\&line=00D4FF\&point=ffffff
